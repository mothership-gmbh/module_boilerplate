...
cp -f _deploy/composer.json ${BUILDENV}
...
cp ${CWD}/_deploy/app/etc/local.xml.phpunit "${BUILDENV}/htdocs/app/etc/local.xml.phpunit"
cp ${CWD}/_deploy/phpunit.xml.dist "${BUILDENV}/htdocs/phpunit.xml.dist"
